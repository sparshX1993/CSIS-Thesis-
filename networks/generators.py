...
class dualAtt_24(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3d_7 = nn.Conv3d(in_channels=32,out_channels=16, kernel_size=1, stride=(1, 1, 1), padding=0)
        self.pathC_bn1 = nn.BatchNorm3d(32)
        ...
        self.path2_block1_conv = nn.Conv3d(
            ...
            padding=1,
            bias=False)
        self.path2_block1_bn = nn.BatchNorm3d(16)
    ...
    def forward(self, x):
        ...
        # print(x_path1.shape,"x_path1 shape")
        # print(x_path2.shape,"x_path2 shape")
        ...
        # print(x.shape)
        x = self.fc1(x)
        # print(x.shape," shape at fc1")
        x = self.relu(x)

        x = self.fc2(x)
        # print(x.shape," shape at fc2 ")
        x = self.relu(x)

        x = self.fc3(x)
        #x = self.relu(x)
        # print(x.shape, "shape at fc3")

        #x = self.fc4(x)
        # print(x.shape, "shape at fc4")
...
class dualAtt_25(nn.Module):
    ...
    def __init__(self):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.conv3d_7 = nn.Conv3d(in_channels=66, out_channels=16, kernel_size=1, stride=(1, 1, 1), padding=0)
        self.pathC_bn1 = nn.BatchNorm3d(66)
        ...
        self.path1_block1_conv = nn.Conv3d(
            ...
            padding=1,
            bias=False)
        self.path1_block1_bn = nn.BatchNorm3d(33)
        self.maxpool_downsample_pathGlobal11 = nn.MaxPool3d(kernel_size=(3, 3, 3), stride=2, padding=1)
        self.path1_block2_conv = nn.Conv3d(
            in_channels=33,
            out_channels=33,
            ...
            padding=1,
            bias=False)
        self.path1_block2_bn = nn.BatchNorm3d(33)
        self.maxpool_downsample_pathGlobal12 = nn.MaxPool3d(kernel_size=(3, 3, 3), stride=(1,2,2), padding=1)
        ...
        self.path2_block1_conv = nn.Conv3d(
            ...
            padding=1,
            bias=False)
        self.path2_block1_bn = nn.BatchNorm3d(33)
        self.maxpool_downsample_pathGlobal21 = nn.MaxPool3d(kernel_size=(3, 3, 3), stride=2, padding=1)
        self.path2_block2_conv = nn.Conv3d(
            in_channels=33,
            out_channels=33,
            ...
            padding=1,
            bias=False)
        self.path2_block2_bn = nn.BatchNorm3d(33)
        self.maxpool_downsample_pathGlobal22 = nn.MaxPool3d(kernel_size=(3, 3, 3), stride=(1,2,2), padding=1)
